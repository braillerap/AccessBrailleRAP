...
latex_documents = [
    (master_doc, 'AccessBrailleRAP.tex', project,
...
man_pages = [
    (master_doc, 'AccessBrailleRAPman', project,
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AccessBrailleRAPtexinfo', project,
     author, 'AccessBrailleRAPtexinfo', 'Braille transcription software for Open source DIY Braille embosser BrailleRAP.',
     'Miscellaneous'),
]
